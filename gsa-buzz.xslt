...
<xsl:variable name="show_googleBuzz">1</xsl:variable>
...
<xsl:template name="results">
  ...
  <!-- *** Output results details *** -->
    ...
    <xsl:if test="($show_res_clusters = '1') or ($show_googleBuzz = '1')">
      <div id='clustering'>
      <xsl:if test="$show_googleBuzz = '1'">
      	<div style='display: block; float: right;'>
      	<script src='http://code.stevenking.com.au/gsa/gbuzz/buzzcoreGSA.js' type='text/javascript'></script>
		<script type='text/javascript'>
			GBuzzGSA.height = '500';
			GBuzzGSA.width = '350';
			GBuzzGSA.load();
